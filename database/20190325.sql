...
CREATE TABLE `base_info_company_fare`  (
  ...
  `create_time` date NULL DEFAULT NULL COMMENT '创建时间',
  `data_source` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据来源',
  PRIMARY KEY (`company_id`, `fare_type`) USING BTREE,
...
CREATE TABLE `base_info_company_pay`  (
  ...
  `create_time` date NULL DEFAULT NULL COMMENT '创建时间',
  `data_source` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据来源',
  PRIMARY KEY (`company_id`, `pay_id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `base_info_company_pay` VALUES (1, '4001', '1', '2', '3', '4', '5', 6, 1, 1, 1, '1', '2018-02-23', NULL);
...
CREATE TABLE `base_info_driver_educate`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网约车驾驶员培训信息接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_info_driver_stat`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '驾驶员统计信息接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_info_vehicle_insurance`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 124 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆保险信息接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `operate_login`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆经营上线接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `operate_logout`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆经营下线接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `position_driver`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '驾驶员定位信息接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `position_vehicle`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆定位信息接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `rated_driver`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '驾驶员信誉信息接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `rated_driver_punish`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '驾驶员处罚信息接口' ROW_FORMAT = Dynamic;
